package com.example.Tuan.BaiKT;


import com.example.Tuan.BaiKT.service.UserService;
    ...
    public SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/products/edit/**", "/products/add", "/products/delete","/categories/add","/categories/edit/**","/categories/delete/**","/categories/delete")
